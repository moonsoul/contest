...
public class ContainsKeys {
	...
	public static  String[] adminpath={"/admin", "/user", "/group"};
	...
	//////
	public static final String	STU_LOGIN_URL	= "/common/timeOut.jsp";
	public static final String	ADMIN_LOGIN_URL	= "/common/adminTimeOut.jsp";
